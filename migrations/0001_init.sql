...
-- Extractions table (structured knowledge)
...
-- Citations table (directed graph: source cites target)
...
-- Entity links (shared methods, datasets, authors between papers)
...
-- FTS5 for full-text search on papers
